...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact Bharat Ahuja.
Designed & Developed by Bharat Ahuja</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ 	Bharat Ahuja :: 2019-2023</h5></center> 
  <hr class="new1">
<br>
</body>
</html>