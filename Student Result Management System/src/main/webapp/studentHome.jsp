...
<center><img src="Clogo.png" width="100" height="80">
<img src="Clogo.jpg" align="right"  width="100" height="100"></center>
  <hr class="new1">
<style>
table{
  width:100%;
...
<body>
  ...
  <h6>Note: Institution doesn't own for the errors or omissions, if any, in this statement.
Designed & Developed by Bharat Ahuja</h6></center>
  <hr class="new1">
